                    ...
                    <div class="card-body p-3 bg-white">
                        ...
                        <form action="{{ route('users.store') }}" method="post">
                            ...
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Nama User" value="{{ old('name') }}">
                                <label for="name">Nama User</label>
                            </div>

                            <div class="form-floating mb-2">
                                <input type="email" class="form-control form-control-sm" id="email" name="email" placeholder="Email User" value="{{ old('email') }}">
                                <label for="email">Email User</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="password" class="form-control form-control-sm" id="password" name="password" placeholder="Password User" value="{{ old('password') }}">
