                    ...
                    <div class="card-body p-3 bg-white">
                        ...
                        <form action="/destination" method="post">
                            ...
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control form-control-sm" id="nama" name="nama" placeholder="Nama Destinasi">
                            ...
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control form-control-sm" id="working_days" name="working_days" placeholder="Working Days">
                            ...
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control form-control-sm" id="ticket_price" name="ticket_price" placeholder="Ticket Price">
